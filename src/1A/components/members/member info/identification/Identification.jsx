...
import { submitMemberIdentificationDetails } from '../../../../../actions/businessMemberActions';
...
function Identification() {
  ...
  const onSubmit = (identificationDetails) => {
    ...
    dispatch(submitMemberIdentificationDetails(finalData));
        ...
        <Card.Body className = "">
            ...
            {edit ? 
                ...
                <form onSubmit={handleSubmit(onSubmit)} as = {Row}>
                    ...
                    <Form.Group className = "identification__form">
