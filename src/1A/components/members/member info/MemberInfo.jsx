                    ...
                    <Row className = {width >= 768 ? "profile__container" : "profile__container__1"}>
                        ...
                        <Col sm>
                            ...
                            <Row>
                                ...
                                <p className = "profile__sub__heading">Review and edit member profile</p>
                            ...
                            <Row>
                                ...
                                <div className = "profile__links profile__links__layout">
                                    ...
                                    <Link to = "/member-information" style = {{color: step_1_color}} onClick = {onPersonalDetailsStep}>Personal Details</Link>
                                    <Link to = "/member-information" className = {width > 507 ? "ml-3" : "mt-1"} style = {{color: step_2_color}} onClick = {onPersonalAddressStep}>Personal Address</Link>
                                    <Link to = "/member-information" className = {width > 507 ? "ml-3" : "mt-1"} style = {{color: step_3_color}} onClick = {onIdentificationStep}>Identification</Link>
